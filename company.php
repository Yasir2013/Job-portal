...
<section>
  <div class="container-fluid">
    ...
    <div class="col-md-12">
      ...
      <p><a class="btn btn-primary btn-lg" href="company-register.php" role="button"><i class="fa fa-plus-square">Company Register</i></a></p>
      </div>
    </div>
  </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-4 col-md-offset-4 well">
      <h2 class="text-center">Company</h2>
        <p class="text-center">This site allows job seekers & recruiters to get connected.</p>
        <div class="pull-left">
          <a href="company-register.php" class="btn btn-default"><i class="fa fa-plus-square"></i>Company Register</a>
        </div>
        <div class="pull-right">
          <a href="company-login.php" class="btn btn-default"><i class="fa fa-user"></i>Company Login</a>
        </div>
     </div>
   </div>
</div>
