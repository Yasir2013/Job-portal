    ...
    <div class="col-md-6 col-md-offset-3 well">
      <h2 class="text-center">Profile</h2>
          ...
          if(isset($_FILES['picture'])){
            ...
            if($pictureup)
            {
             $sql="UPDATE company SET Propic='$name' WHERE id_company='$_SESSION[id_user]'";
             mysqli_query($conn,$sql);
             ?>
             <script>
             alert('successfully uploaded');
                   window.location.href='companyprofile.php?success';
                   </script>
             <?php
            }
            else
          ...
          <form method="post" enctype="multipart/form-data">
           ...
           <div class="form-group">
             <label for="picture">Upload Company Logo</label>
         ...
         <p><br/></p>
         <p><br/></p>
        <form method="post" action="updatecompanyprofile.php">
          <?php
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="companyname" name="companyname" placeholder="First Name" value="<?php echo $row['companyname']; ?>" required="">
          </div>
          <div class="form-group">
            <label for="companytype">Company Type</label>
            <input type="text" class="form-control" id="companytype" name="companytype" placeholder="Last Name" value="<?php echo $row['companytype']; ?>" required="">
          </div>
          <div class="form-group">
         ...
         <div class="form-group">
           ...
           <textarea id="address" name="headofficecity" class="form-control" rows="5" placeholder="Address" ><?php echo $row['headofficecity']; ?></textarea>
         </div>
         <div class="form-group">
